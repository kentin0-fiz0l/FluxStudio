...
// Factory function to create mock consultations with fresh dates
function createMockConsultations(): ConsultationSession[] {
  const now = Date.now();
  return [
    {
      id: 'consultation-1',
      ...
      scheduledAt: new Date(now + 2 * 60 * 60 * 1000), // 2 hours from now
      duration: 60,
      status: 'scheduled',
    ...
    },
    {
      ...
      facilitator: { id: 'kentino', name: 'Kentino', userType: 'designer', avatar: '/avatars/kentino.jpg' },
      scheduledAt: new Date(now - 7 * 24 * 60 * 60 * 1000), // Last week
      duration: 45,
      status: 'completed',
...
// Default mock consultations - use useMemo in component for fresh dates
const defaultMockConsultations = createMockConsultations();
