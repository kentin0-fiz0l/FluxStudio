...
const mockDesignReview: DesignReview = {
  id: 'review-1',
  messageId: 'msg-1',
  fileId: 'file-1',
  projectId: 'project-1',
...
const mockDesignVersions: DesignVersion[] = [
  {
    id: 'version-3',
    version: 'v3.0',
...
export function DesignReviewWidget({
  ...
  const [activeVersion, setActiveVersion] = useState(mockDesignVersions[0]);
    ...
    <div className={`bg-white rounded-lg border border-gray-200 ${className}`}>
      ...
      <div className="p-4 border-b border-gray-200">
        ...
        <div className="flex items-center justify-between text-sm text-gray-600">
          ...
          >
            {mockDesignVersions.length} versions
          </button>
        </div>
      </div>
          ...
          >
            <div className="p-4">
              ...
              <div className="space-y-2">
                {mockDesignVersions.map((version) => (
                  <button
                    key={version.id}
