                ...
                >
                  <Card
                    className={cn(
                      ...
                      selectedFileId === fileObj.id && 'ring-2 ring-blue-500'
                    )}
                    onClick={() =>
                      setSelectedFileId(
                        selectedFileId === fileObj.id ? null : fileObj.id
                      )
                    }
                  >
                          ...
                          {(fileObj.status === 'uploading' ||
                            ...
                            <div className="mb-2">
                              <Progress
                                ...
                                className={cn(
                                  'h-1',
                                  fileObj.status === 'analyzing' && 'bg-purple-200'
                                )}
                              />
                            ...
                            <div className="mb-2 space-y-1">
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {fileObj.analysis.confidence && (
                                  ...
                                  >
                                    {Math.round(fileObj.analysis.confidence * 100)}%
                                    confidence
                                  </Badge>
                                )}
                                ...
                                <div className="flex items-center gap-1 flex-wrap">
                                  ...
                                  {fileObj.selectedTags.length > 3 && (
                                    <span className="text-xs text-gray-500">
                                      +{fileObj.selectedTags.length - 3} more
                                    </span>
                                  )}
                                </div>
                              )}
