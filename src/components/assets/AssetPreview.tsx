...
export const assetTypeConfig: Record<string, { icon: string; label: string; color: string }> = {
  ...
  file: { icon: 'M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z', label: 'File', color: 'bg-neutral-100 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300' },
    ...
    <>
      ...
      <div className="aspect-video bg-neutral-100 dark:bg-neutral-800 rounded-lg overflow-hidden flex items-center justify-center">
        {asset.thumbnailUrl || asset.fileUrl ? (
          ...
          <svg className="w-20 h-20 text-neutral-300 dark:text-neutral-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {isEditing ? (
        <textarea
          ...
          className="w-full border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 rounded-lg p-2 text-sm"
          rows={3}
        />
      ) : asset.description ? (
