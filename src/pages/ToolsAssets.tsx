            ...
            {loading ? (
              ...
              <div className="text-center py-12 max-w-md mx-auto">
                ...
                {searchQuery || kindFilter !== 'all' ? (
                  <>
                    <div className="text-gray-900 font-semibold mb-2">No assets found</div>
                    <div className="text-sm text-gray-500 mb-4">
                      No assets match your current filters. Try adjusting your search or clear the filter.
                    </div>
                    <button
                  ...
                  <>
                    <div className="text-gray-900 font-semibold mb-2">No assets yet</div>
                    <div className="text-sm text-gray-500 mb-4">
                      Assets are reusable creative elements like logos, audio clips, or documents.
                      Upload files first, then convert them to assets for easy reuse across projects.
                    </div>
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="text-xs text-gray-400 mt-2">
                        <strong>Pro tip:</strong> Select a file and click "Create Asset" to add it here
                      </div>
                    </div>
                  </>
                )}
