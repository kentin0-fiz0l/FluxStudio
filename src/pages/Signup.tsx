...
export function Signup() {
  ...
  const handleGoogleSignup = async (response: any) => {
    console.log('🚀 Google OAuth Signup Success');
    setError('');
    ...
    <div className="min-h-screen bg-background text-foreground relative flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto p-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-4">Create your creative account</p>
        </div>
      ...
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          #google-oauth-signup-container,
          #google-oauth-signup-container *,
          #google-oauth-signup-container iframe,
          #google-oauth-signup-container div,
          #google-oauth-signup-container div[role="button"],
          #google-oauth-signup-container button,
          #google-oauth-signup-container span,
          #google-oauth-signup-container [class*="gsi"],
          #google-oauth-signup-container [id*="gsi"],
          #google-oauth-signup-container > div,
          #google-oauth-signup-container > div > div,
          #google-oauth-signup-container > div > div > div,
          .google-oauth-wrapper,
          .google-oauth-wrapper *,
