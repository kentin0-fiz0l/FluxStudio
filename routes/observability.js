...
router.post('/events', authenticateToken, zodValidate(observabilityEventsSchema), asyncHandler(async (req, res) => {
...
router.get('/vitals/summary', authenticateToken, asyncHandler(async (req, res) => {
