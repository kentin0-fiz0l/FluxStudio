 ...
 */
router.get('/projects/:projectId/documents', authenticateToken, asyncHandler(async (req, res) => {
 ...
 */
router.post('/projects/:projectId/documents', authenticateToken, rateLimitByUser(20, 60000), zodValidate(createDocumentSchema), asyncHandler(async (req, res) => {
  const { projectId } = req.params;
  const userId = req.user.id;
 ...
 */
router.patch('/documents/:documentId', authenticateToken, zodValidate(updateDocumentSchema), asyncHandler(async (req, res) => {
  const { documentId } = req.params;
  const userId = req.user.id;
 ...
 */
router.get('/documents/:documentId/versions', authenticateToken, asyncHandler(async (req, res) => {
  const { documentId } = req.params;
  const userId = req.user.id;
 ...
 */
router.get('/documents/:documentId/versions/:versionNumber', authenticateToken, asyncHandler(async (req, res) => {
 ...
 */
router.get('/documents/:documentId/versions/:v1/diff/:v2', authenticateToken, asyncHandler(async (req, res) => {
