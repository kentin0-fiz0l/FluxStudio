 ...
 */
router.get('/:id/messages', authenticateToken, requireConversationAccess('id'), async (req, res) => {
  try {
 ...
 */
router.post('/:id/messages', authenticateToken, requireConversationAccess('id'), zodValidate(createMessageSchema), async (req, res) => {
  try {
    const userId = req.user.id;
    const conversationId = req.params.id;
 ...
 */
router.get('/:conversationId/threads/:threadRootMessageId/messages', authenticateToken, requireConversationAccess(), async (req, res) => {
  try {
    const userId = req.user.id;
 ...
 * Get thread summary
 */
router.get('/:conversationId/threads/:threadRootMessageId/summary', authenticateToken, requireConversationAccess(), async (req, res) => {
  try {
    const userId = req.user.id;
    const { conversationId, threadRootMessageId } = req.params;
 ...
 */
router.put('/:conversationId/messages/:messageId', authenticateToken, requireConversationAccess(), async (req, res) => {
  try {
    const userId = req.user.id;
 ...
 */
router.delete('/:conversationId/messages/:messageId', authenticateToken, requireConversationAccess(), async (req, res) => {
  try {
    const userId = req.user.id;
    const { conversationId, messageId } = req.params;
