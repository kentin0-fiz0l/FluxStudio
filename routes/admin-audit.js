 ...
 */
router.get('/', zodValidateQuery(listAuditLogsQuerySchema), asyncHandler(async (req, res) => {
  const {
    action,
    resource,
    userId,
 ...
 */
router.get('/export', zodValidateQuery(exportAuditLogsQuerySchema), asyncHandler(async (req, res) => {
