 ...
 */
router.post('/', authenticateToken, zodValidate(createAssetSchema), asyncHandler(async (req, res) => {
 ...
 */
router.get('/:assetId', authenticateToken, asyncHandler(async (req, res) => {
 ...
 */
router.patch('/:assetId', authenticateToken, zodValidate(updateAssetSchema), asyncHandler(async (req, res) => {
  const { assetId } = req.params;
 ...
 * Delete asset
 */
router.delete('/:assetId', authenticateToken, asyncHandler(async (req, res) => {
  const { assetId } = req.params;
 ...
 * Create new version
 */
router.post('/:assetId/versions', authenticateToken, zodValidate(createAssetVersionSchema), asyncHandler(async (req, res) => {
  const { assetId } = req.params;
 ...
 * Set primary version
 */
router.post('/:assetId/primary', authenticateToken, zodValidate(setPrimaryVersionSchema), asyncHandler(async (req, res) => {
  const { assetId } = req.params;
 ...
 * Get versions list
 */
router.get('/:assetId/versions', authenticateToken, asyncHandler(async (req, res) => {
  const { assetId } = req.params;
 ...
 */
router.get('/:assetId/projects', authenticateToken, asyncHandler(async (req, res) => {
  const { assetId } = req.params;
 ...
 */
router.post('/projects/:projectId/assets', authenticateToken, zodValidate(linkProjectAssetSchema), fileUpload.array('files', 10), asyncHandler(async (req, res) => {
 ...
 */
router.delete('/projects/:projectId/assets/:assetId', authenticateToken, asyncHandler(async (req, res) => {
 ...
 */
router.get('/projects/:projectId/assets', authenticateToken, asyncHandler(async (req, res) => {
  const { projectId } = req.params;
