 ...
 */
router.get('/:projectId', authenticateToken, requireProjectAccess(), asyncHandler(async (req, res) => {
...
router.post('/', authenticateToken, validateInput.sanitizeInput, checkProjectQuota, zodValidate(createProjectSchema), asyncHandler(async (req, res) => {
  const userId = req.user.id;
  const {
 ...
 * Update a project
 */
router.put('/:projectId', authenticateToken, requireProjectAccess(), validateInput.sanitizeInput, zodValidate(updateProjectSchema), asyncHandler(async (req, res) => {
  const { projectId } = req.params;
  const userId = req.user.id;
 ...
 * Delete a project
 */
router.delete('/:projectId', authenticateToken, requireProjectAccess(), asyncHandler(async (req, res) => {
  const { projectId } = req.params;
  const userId = req.user.id;
 ...
 */
router.get('/:projectId/activity', authenticateToken, requireProjectAccess(), asyncHandler(async (req, res) => {
  const { projectId } = req.params;
 ...
 */
router.get('/:projectId/conversation', authenticateToken, requireProjectAccess(), asyncHandler(async (req, res) => {
  const { projectId } = req.params;
  const userId = req.user.id;
 ...
 * Get project members
 */
router.get('/:projectId/members', authenticateToken, requireProjectAccess(), asyncHandler(async (req, res) => {
  const { projectId } = req.params;
 ...
 */
router.post('/:projectId/members', authenticateToken, requireProjectAccess(), validateInput.sanitizeInput, zodValidate(addProjectMemberSchema), asyncHandler(async (req, res) => {
  const { projectId } = req.params;
 ...
 */
router.delete('/:projectId/members/:userId', authenticateToken, requireProjectAccess(), asyncHandler(async (req, res) => {
 ...
 * Update member role
 */
router.put('/:projectId/members/:userId', authenticateToken, requireProjectAccess(), validateInput.sanitizeInput, zodValidate(updateProjectMemberRoleSchema), asyncHandler(async (req, res) => {
  const { projectId, userId: memberUserId } = req.params;
  const { role } = req.body;
 ...
 */
router.get('/activities/recent', authenticateToken, asyncHandler(async (req, res) => {
  const userId = req.user.id;
  const { limit = 20, offset = 0 } = req.query;
 ...
 */
router.get('/:projectId/counts', authenticateToken, requireProjectAccess(), asyncHandler(async (req, res) => {
  const { projectId } = req.params;
