 ...
 * Create a new team
 */
router.post('/', authenticateToken, zodValidate(createTeamSchema), asyncHandler(async (req, res) => {
 ...
 * Update team
 */
router.put('/:id', authenticateToken, zodValidate(updateTeamSchema), asyncHandler(async (req, res) => {
  const teams = await getTeams();
 ...
 */
router.post('/:id/invite', authenticateToken, zodValidate(inviteTeamMemberSchema), asyncHandler(async (req, res) => {
 ...
 */
router.post('/:id/accept-invite', authenticateToken, asyncHandler(async (req, res) => {
  const teams = await getTeams();
  const teamIndex = teams.findIndex(t => t.id === req.params.id);
 ...
 * Update member role
 */
router.put('/:id/members/:userId', authenticateToken, zodValidate(updateTeamMemberRoleSchema), asyncHandler(async (req, res) => {
  const { role } = req.body;
 ...
 */
router.get('/:id/invites', authenticateToken, asyncHandler(async (req, res) => {
  const teams = await getTeams();
  const team = teams.find(t => t.id === req.params.id);
 ...
 */
router.delete('/:id/invites/:inviteId', authenticateToken, asyncHandler(async (req, res) => {
  const teams = await getTeams();
  const teamIndex = teams.findIndex(t => t.id === req.params.id);
